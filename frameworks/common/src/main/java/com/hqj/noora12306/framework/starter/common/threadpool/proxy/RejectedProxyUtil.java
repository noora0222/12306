...
import com.hqj.noora12306.framework.starter.common.toolkit.ThreadUtil;
...
public final class RejectedProxyUtil {
    ...
    public static void main(String[] args) {
        ...
        //这里public static class AbortPolicy implements RejectedExecutionHandler 就是继承了RejectedExecutionHandler
        ...
        //proxyRejectedExecutionHandler这个类时JDK proxy创建的代理类，把代理类复制到线程池内，这样线程池拒绝任务时就会包含代理类中的行为。
        threadPoolExecutor.setRejectedExecutionHandler(proxyRejectedExecutionHandler);
        for (int i = 0; i < 5; i++) {
            try {
                threadPoolExecutor.execute(() -> ThreadUtil.sleep(1000L));
